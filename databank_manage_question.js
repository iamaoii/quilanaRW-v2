$(document).ready(function () {
        ...
        fetch("databank_ajax_create_assessment.php", {
            ...
            .then((data) => {
                if (data.success) {
                    ...
                    addSelectedQuestionsToAssessment(assessmentId, function (successAdd, message) {
            ...
            .finally(() => {
                $("#new_assessment_submit").prop("disabled", false).text("Create & Add");
            });
    });
    ...
    $("#confirm_add_to").click(function () {
        ...
        $("#confirm_add_to").prop("disabled", true).html('<i class="fa fa-spinner fa-spin"></i> Adding...');
        ...
        addSelectedQuestionsToAssessment(assessmentId, function (success, message) {
            ...
            $("#confirm_add_to").prop("disabled", false).html('<i class="fa fa-save"></i> Add to Assessment');
        });
    });
